  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">{t('monitoring.Monitoring Dashboard')}</h2>
          <p className="text-gray-500">{t('monitoring.Real-time request tracking and metrics')}</p>
        </div>
